...
!(function (e, t, n, o, i) {
  ...
  function ie(e, t) {
    e = se(e) ? e[0] : e;
    for (
      var n = null != t ? K(t, e.parentNode) : e.parentNode.childNodes,
        o = 0,
        i = 0;
      i < n.length;
      i++
  ...
  function de(e, n, o) {
    ...
    for (var r = 0; r < e.length; r++) {
      var l = e[r];
      ((o && !r) || !o) &&
        ((i = n.cloneNode(!0)), l.parentNode.insertBefore(i, l)),
        i.appendChild(l);
    }
    return e;
  }
  ...
  function pe(e, t) {
    for (
      "string" == typeof t && (t = Ae(t)), e.appendChild(t);
      e.firstChild !== t;
  ...
  function Le(n, o, i) {
    ...
    (i = void 0 === i ? {} : i),
      "function" == typeof e.CustomEvent
        ? (r = new CustomEvent(o, { detail: i }))
        : (r = t.createEvent("CustomEvent")).initCustomEvent(o, !0, !0, i),
      n.dispatchEvent(r);
  }
  function xe(e, t) {
    return (
    ...
    function (P, F) {
      ...
      if (!Q(K("html"), a)) {
        ...
        jn(),
          ...
          Ne &&
            ((de.version = "3.0.2"),
            (de.setAutoScrolling = ft),
            (de.setRecordHistory = dt),
            (de.setScrollingSpeed = vt),
            (de.setFitToSection = pt),
            (de.setLockAnchors = function (e) {
              F.lockAnchors = e;
            }),
            (de.setMouseWheelScrolling = ht),
            (de.setAllowScrolling = gt),
            (de.setKeyboardScrolling = St),
            (de.moveSectionUp = bt),
            (de.moveSectionDown = wt),
            (de.silentMoveTo = yt),
            (de.moveTo = Et),
            (de.moveSlideRight = Lt),
            (de.moveSlideLeft = xt),
            (de.fitToSection = Bt),
            (de.reBuild = Tt),
            (de.setResponsive = At),
            (de.getFullpageData = F),
            (de.destroy = function (n) {
              ft(!1, "internal"),
                gt(!0),
                mt(!1),
                St(!1),
                ...
                e.removeEventListener("hashchange", on),
                e.removeEventListener("resize", hn),
                t.removeEventListener("keydown", ln),
                t.removeEventListener("keyup", an),
                ...
                n &&
                  ...
                  ke(K(E + ", " + N + ", " + D)),
                  $(K(h), { height: "", "background-color": "", padding: "" }),
                  $(K(M), { width: "" }),
                  $(Ne, {
                    height: "",
                    position: "",
                  ...
                  K(h + ", " + M).forEach(function (e) {
                    F.scrollOverflowHandler &&
                      F.scrollOverflowHandler.remove(e),
                      ue(e, B + " " + c + " " + f);
                  ...
                  Sn(Ne),
                  [S, R, H].forEach(function (e) {
                    K(e, Ne).forEach(function (e) {
                      e.outerHTML = e.innerHTML;
                    });
                  }),
                  $(Ne, { "-webkit-transition": "none", transition: "none" }),
                  e.scrollTo(0, 0),
                  [p, k, I].forEach(function (e) {
                    ue(K("." + e), e);
                  }));
            }),
            ...
            (de.test = {
              ...
              translate3dH: (function () {
                for (
                  var e = [], t = 0;
                  t < K(F.sectionSelector, Ne).length;
                  t++
                )
            ...
            (de.shared = { afterRenderActions: It }),
            (e.fullpage_api = de),
            F.css3 &&
              (F.css3 = (function () {
                var n,
                ...
                for (var r in ((o.style.display = "block"),
                t.body.insertBefore(o, null),
                i))
                  void 0 !== o.style[r] &&
                    ((o.style[r] = "translate3d(1px,1px,1px)"),
                    (n = e.getComputedStyle(o).getPropertyValue(i[r])));
                return (
            ...
            (function () {
              $(Ne, { height: "100%", position: "relative" }),
                ce(Ne, n),
                ce(K("html"), a),
                (je = G()),
                ue(Ne, l),
                ce(K(F.sectionSelector, Ne), p),
                ce(K(F.slideSelector, Ne), k);
              for (var e = K(h), i = 0; i < e.length; i++) {
                ...
                s.setAttribute("data-fp-styles", s.getAttribute("style")),
                  (m = s),
                  (S = r) || null != K(g)[0] || ce(m, c),
                  (Ie = K(g)[0]),
                  $(m, { height: je + "px" }),
                  F.paddingTop && $(m, { "padding-top": F.paddingTop }),
                  F.paddingBottom &&
                    $(m, { "padding-bottom": F.paddingBottom }),
                  void 0 !== F.sectionsColor[S] &&
                    $(m, { "background-color": F.sectionsColor[S] }),
                  void 0 !== F.anchors[S] &&
                    m.setAttribute("data-anchor", F.anchors[S]),
                  (d = s),
                  (v = r),
                  void 0 !== F.anchors[v] && Q(d, c) && bn(F.anchors[v], v),
                  F.menu &&
                    F.css3 &&
                    null != he(K(F.menu)[0], o) &&
                    se.appendChild(K(F.menu)[0]),
                  f > 0 ? Ct(s, u, f) : F.verticalCentered && yn(s);
              }
              var d, v, m, S;
              F.fixedElements &&
                F.css3 &&
                K(F.fixedElements).forEach(function (e) {
                  se.appendChild(e);
                }),
                F.navigation &&
                  (function () {
                    ...
                    var o = K(E)[0];
                    ce(o, "fp-" + F.navigationPosition),
                      F.showActiveTooltip && ce(o, T);
                    for (var i = "", r = 0; r < K(h).length; r++) {
                      var l = "";
                      F.anchors.length && (l = F.anchors[r]),
                        (i +=
                          '<li><a href="#' +
                          l +
                    ...
                    (K("ul", o)[0].innerHTML = i),
                      $(K(E), {
                        "margin-top": "-" + K(E)[0].offsetHeight / 2 + "px",
                      }),
                      ce(K("a", K("li", K(E)[0])[ie(K(g)[0], h)]), c);
                  })(),
                K('iframe[src*="youtube.com/embed/"]', Ne).forEach(function (
                  e
                ) {
                  var t, n, o;
                  (n = "enablejsapi=1"),
                ...
                F.scrollOverflow
                  ? (Fe = F.scrollOverflowHandler.init(F))
                  : It();
            })(),
            gt(!0),
            mt(!0),
            ft(F.autoScrolling, "internal"),
            gn(),
            Cn(),
            "complete" === t.readyState && nn(),
            e.addEventListener("load", nn),
            e.addEventListener("scroll", Rt),
            e.addEventListener("hashchange", on),
            e.addEventListener("blur", fn),
            e.addEventListener("resize", hn),
            t.addEventListener("keydown", ln),
            t.addEventListener("keyup", an),
            ["click", "touchstart"].forEach(function (e) {
      ...
      function ft(e, t) {
        ...
        if (F.autoScrolling && !F.scrollBar)
          $(re, { overflow: "hidden", height: "100%" }),
            dt(et.recordHistory, "internal"),
            $(Ne, { "-ms-touch-action": "none", "touch-action": "none" }),
            null != n && Rn(n.offsetTop);
        else if (
          ($(re, { overflow: "visible", height: "initial" }),
          dt(!1, "internal"),
          $(Ne, { "-ms-touch-action": "", "touch-action": "" }),
          null != n)
        ) {
          ...
          ? ((function () {
              ...
              var i =
                "onwheel" in t.createElement("div")
                  ...
                  : "DOMMouseScroll";
              "DOMMouseScroll" == i
                ? t[n](o + "MozMousePixelScroll", Yt, !1)
                : t[n](o + i, Yt, !1);
            })(),
            Ne.addEventListener("mousedown", sn),
            Ne.addEventListener("mouseup", cn))
          : (t.addEventListener
              ? (t.removeEventListener("mousewheel", Yt, !1),
                t.removeEventListener("wheel", Yt, !1),
                t.removeEventListener("MozMousePixelScroll", Yt, !1))
              : t.detachEvent("onmousewheel", Yt),
            Ne.removeEventListener("mousedown", sn),
            Ne.removeEventListener("mouseup", cn));
      }
      function gt(e, t) {
        void 0 !== t
      ...
      function mt(e) {
        e
          ? (ht(!0),
            (Be || ze) &&
              (F.autoScrolling &&
                (se.removeEventListener(Je.touchmove, Nt, { passive: !1 }),
                se.addEventListener(Je.touchmove, Nt, { passive: !1 })),
              K(o)[0].removeEventListener(Je.touchstart, Dt),
              K(o)[0].removeEventListener(Je.touchmove, jt, { passive: !1 }),
              K(o)[0].addEventListener(Je.touchstart, Dt),
              K(o)[0].addEventListener(Je.touchmove, jt, { passive: !1 })))
          : (ht(!1),
            (Be || ze) &&
              (F.autoScrolling &&
                (se.removeEventListener(Je.touchmove, jt, { passive: !1 }),
                se.removeEventListener(Je.touchmove, Nt, { passive: !1 })),
              K(o)[0].removeEventListener(Je.touchstart, Dt),
              K(o)[0].removeEventListener(Je.touchmove, jt, { passive: !1 })));
      }
      ...
      function bt() {
        var e = Z(K(g)[0], h);
        e || (!F.loopTop && !F.continuousVertical) || (e = oe(K(h))),
          null != e && Wt(e, null, !0);
      }
      function wt() {
        var e = ee(K(g)[0], h);
        e || (!F.loopBottom && !F.continuousVertical) || (e = K(h)[0]),
          null != e && Wt(e, null, !1);
      }
      function yt(e, t) {
        ...
        if (!Q(Ne, l)) {
          ...
          for (var n = K(h), o = 0; o < n.length; ++o) {
            var i = n[o],
              r = K(H, i)[0],
              a = K(M, i);
            F.verticalCentered && $(K(S, i), { height: En(i) + "px" }),
              $(i, { height: je + "px" }),
          ...
          s && yt(s + 1),
            ...
            Ee(F.afterResize) &&
              t &&
              F.afterResize.call(Ne, e.innerWidth, e.innerHeight),
            Ee(F.afterReBuild) && !t && F.afterReBuild.call(Ne);
        }
      }
      function At(e) {
        var t = Q(se, i);
        e
          ? t ||
            ...
            le(K(E)),
            ce(se, i),
            Ee(F.afterResponsive) && F.afterResponsive.call(Ne, e))
          : t &&
            (ft(et.autoScrolling, "internal"),
            pt(et.autoScrolling, "internal"),
            ae(K(E)),
            ue(se, i),
            Ee(F.afterResponsive) && F.afterResponsive.call(Ne, e));
      }
      ...
      function Ot(e) {
        e.target != t &&
          F.normalScrollElements.split(",").forEach(function (n) {
      ...
      function Ct(e, n, o) {
        ...
        (u.className = I),
          ...
          n.forEach(function (e) {
            $(e, { width: r + "%" }), F.verticalCentered && yn(e);
          });
        var f = K(O, e)[0];
        null != f && (0 !== ie(K(g), h) || (0 === ie(K(g), h) && 0 !== ie(f)))
          ? In(f, "internal")
          : ce(n[0], c);
      }
      function Ht(e, t) {
      ...
      function It() {
        ...
        ce(t, f),
          ...
          (!(e = xn(rn().section)) || (void 0 !== e && ie(e) === ie(Ie))) &&
            Ee(F.afterLoad) &&
            Xt("afterLoad", {
              activeSection: null,
              element: t,
      ...
      function Rt() {
        ...
        if (!F.autoScrolling || F.scrollBar) {
          ...
          if (
            ...
            (r = i + G()),
            ("up" == o ? r >= be() + G() : i <= be()) &&
              (Q(K(g)[0], f) || (ce(K(g)[0], f), ue(we(K(g)[0]), f))),
            !Q((e = v[s]), c))
          ) {
            tt = !0;
            var m,
            ...
            x && ((S = x.getAttribute("data-anchor")), (m = ie(x))),
              Ve &&
                (ce(e, c),
                ue(we(e), c),
                Ee(F.onLeave) && Xt("onLeave", T),
                Ee(F.afterLoad) && Xt("afterLoad", T),
                en(b),
                $t(e),
                Jt(e),
                bn(E, L - 1),
                F.anchors.length && (Se = E),
                kn(m, S, E)),
              clearTimeout(Ke),
      ...
      function jt(t) {
        ...
        if (Pt(t)) {
          ...
          (rt = o.y),
            (lt = o.x),
            K(H, n).length && Math.abs(it - lt) > Math.abs(ot - rt)
              ? !Re &&
                Math.abs(it - lt) > (e.innerWidth / 100) * F.touchSensitivity &&
                (it > lt ? Ue.m.right && Lt(n) : Ue.m.left && xt(n))
              : F.autoScrolling &&
                Ve &&
                Math.abs(ot - rt) >
                  (e.innerHeight / 100) * F.touchSensitivity &&
                (ot > rt ? zt("down") : rt > ot && zt("up"));
        }
      }
      function Pt(e) {
      ...
      function Vt(e, t) {
        for (
          var n = 0, o = e.slice(Math.max(e.length - t, 1)), i = 0;
          i < o.length;
          i++
        )
          n += o[i];
      ...
      function Yt(t) {
        ...
        if (F.autoScrolling && !He && !o) {
          ...
          return (
            (at = n),
            s > 200 && (Ye = []),
            Ve && Vt(Ye, 10) >= Vt(Ye, 70) && a && zt(r < 0 ? "down" : "up"),
            !1
          );
        }
        F.fitToSection && (Ge = !1);
      ...
      function Wt(e, t, n) {
        if (null != e) {
          ...
          if (
            !(
              (v.activeSection == e && !Pe) ||
              (F.scrollBar && be() === v.dtop && !Q(e, b))
            )
          ) {
            if (
              (null != v.activeSlide &&
                ((f = v.activeSlide.getAttribute("data-anchor")),
                (d = ie(v.activeSlide))),
              Ee(F.onLeave) && !v.localIsResizing)
            ) {
              var p = v.yMovement;
              if (
                (void 0 !== n && (p = n ? "up" : "down"),
                (v.direction = p),
                !1 === Xt("onLeave", v))
              )
                return;
            ...
            F.autoScrolling &&
              ...
              ((m = v).isMovementUp
                ? me(K(g)[0], Oe(m.activeSection, h))
                : ge(K(g)[0], Ce(m.activeSection, h).reverse()),
              Rn(K(g)[0].offsetTop),
              Ft(),
              (m.wrapAroundElements = m.activeSection),
              (m.dtop = m.element.offsetTop),
              (m.yMovement = wn(m.element)),
              (m.leavingSection = ie(m.activeSection, h) + 1),
              (m.sectionIndex = ie(m.element, h)),
              (v = m)),
              v.localIsResizing || en(v.activeSection),
              F.scrollOverflow && F.scrollOverflowHandler.beforeLeave(),
              ce(e, c),
              ue(we(e), c),
              $t(e),
              F.scrollOverflow && F.scrollOverflowHandler.onLeave(),
              (Ve = de.test.isTesting),
              kn(d, f, v.anchorLink, v.sectionIndex),
              (function (e) {
                if (F.css3 && F.autoScrolling && !F.scrollBar) {
                  ...
                  var n = qt(e.dtop);
                  (de.test.top = -e.dtop + "px"),
                    Pn(n.element, n.options, F.scrollingSpeed, function () {
                      F.scrollBar
                        ? setTimeout(function () {
                            Qt(e);
                          }, 30)
              ...
              (Se = v.anchorLink),
              bn(v.anchorLink, v.sectionIndex);
          }
        }
        var m;
      }
      ...
      function Qt(e) {
        ...
        null != (t = e).wrapAroundElements &&
          (t.isMovementUp
            ? me(K(h)[0], t.wrapAroundElements)
            : ge(K(h)[K(h).length - 1], t.wrapAroundElements),
          Rn(K(g)[0].offsetTop),
          Ft()),
          Ee(F.afterLoad) && !e.localIsResizing && Xt("afterLoad", e),
          F.scrollOverflow && F.scrollOverflowHandler.afterLoad(),
          e.localIsResizing || Jt(e.element),
          ce(e.element, f),
          ue(we(e.element), f),
          (Ve = !0),
          Ee(e.callback) && e.callback();
      }
      function Gt(e, t) {
      ...
      function ln(e) {
        ...
        9 === o
          ? (function (e) {
              ...
              ((n = e),
              (o = un(t)),
              (i = o.indexOf(t.activeElement)),
              (r = n.shiftKey ? i - 1 : i + 1),
              (l = o[r]),
              (a = Kt(he(l, M))),
              (s = _t(he(l, h))),
              a || s) &&
                (u ? null == he(u, g + "," + g + " " + O) && (u = d(e)) : d(e),
                ((!c && u == f[f.length - 1]) || (c && u == f[0])) && ye(e));
            })(e)
          : xe(n, "textarea") ||
            xe(n, "input") ||
            xe(n, "select") ||
            ...
            !F.keyboardScrolling ||
            !F.autoScrolling ||
            ([40, 38, 32, 33, 34].indexOf(o) > -1 && ye(e),
            (He = e.ctrlKey),
            (Qe = setTimeout(function () {
              !(function (e) {
                var t = e.shiftKey;
      ...
      function dn(e) {
        Ve &&
          (e.pageY < ct && Ue.m.up ? bt() : e.pageY > ct && Ue.m.down && wt()),
          (ct = e.pageY);
      }
      function vn(e, t, n) {
        var o,
        ...
        (l.xMovement =
          ...
          !1 === Xt("onSlideLeave", l)
            ...
            : (ce(t, c),
              ue(we(t), c),
              l.localIsResizing || (en(l.prevSlide), $t(t)),
              !F.loopHorizontal &&
                F.controlArrows &&
                (Te(K(U, r), 0 !== l.slideIndex), Te(K(X, r), null != ne(t))),
              Q(r, c) &&
                !l.localIsResizing &&
                kn(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex),
              (function (e, t, n) {
                var o = t.destinyPos;
                if (F.css3) {
                  var i =
                    "translate3d(-" + Math.round(o.left) + "px, 0px, 0px)";
                  (de.test.translate3dH[t.sectionIndex] = i),
                    $(mn(K(R, e)), Bn(i)),
                    (_e = setTimeout(function () {
                      n && pn(t);
                    }, F.scrollingSpeed));
                } else
                  (de.test.left[t.sectionIndex] = Math.round(o.left)),
                    Pn(e, Math.round(o.left), F.scrollingSpeed, function () {
                      n && pn(t);
                    });
              })(e, l, !0));
      }
      function pn(e) {
        ...
        (t = e.slidesNav),
          ...
          F.slidesNavigation &&
            null != t &&
            (ue(K(u, t), c), ce(K("a", K("li", t)[n]), c)),
          e.localIsResizing ||
            (Ee(F.afterSlideLoad) && Xt("afterSlideLoad", e),
            (Ve = !0),
            Jt(e.destiny)),
          (Re = !1);
      }
      ...
      function bn(e, t) {
        ...
        (n = e),
          ...
          F.menu &&
            null != o &&
            (ue(K(u, o), c), ce(K('[data-menuanchor="' + n + '"]', o), c)),
          (i = e),
          (r = t),
          F.navigation &&
            null != K(E)[0] &&
      ...
      function Tn(e, t) {
        ...
        if (null != n) {
          var o,
            ...
            l =
              (null ==
                (r = K(M + '[data-anchor="' + (o = t) + '"]', (i = n))[0]) &&
                ((o = void 0 !== o ? o : 0), (r = K(M, i)[o])),
              r);
          On(n) === Se || Q(n, c)
            ? An(l)
            : Wt(n, function () {
      ...
      function In(e, t) {
        vt(0, "internal"),
          ...
          vn(he(e, H), e),
          void 0 !== t && (Pe = !1),
          vt(et.scrollingSpeed, "internal");
      }
      function Rn(e) {
        var t = Math.round(e);
        if (F.css3 && F.autoScrolling && !F.scrollBar)
          Ln("translate3d(0px, -" + t + "px, 0px)", !1);
        else if (F.autoScrolling && !F.scrollBar)
          $(Ne, { top: -t + "px" }), (de.test.top = -t + "px");
        else {
          var n = qt(t);
      ...
      function zn(e, t, n) {
        "all" !== t
          ? (Ue[n][t] = e)
          : Object.keys(Ue[n]).forEach(function (t) {
              Ue[n][t] = e;
            });
      }
      function Nn(e, t, n) {
      ...
      function jn() {
        J ||
          ...
          _("error", "https://github.com/alvarotrigo/fullPage.js#options.")),
          Q(K("html"), a)
            ? _(
                "error",
            ...
            : (F.continuousVertical &&
              ...
              F.anchors.forEach(function (e) {
                var t = [].slice.call(K("[name]")).filter(function (t) {
                    return (
                      t.getAttribute("name") &&
                      t.getAttribute("name").toLowerCase() == e.toLowerCase()
                    );
                  }),
      ...
      function Pn(t, n, o, i) {
        ...
        var c = function () {
          if (Ge) {
            var r = n;
            (s += 20),
              o && (r = e.fp_easings[F.easing](s, l, a, o)),
              Dn(t, r),
              s < o ? setTimeout(c, 20) : void 0 !== i && i();
          } else s < o && i();
        };
        c();
      }
      function Dn(t, n) {
        !F.autoScrolling || F.scrollBar || (t.self != e && Q(t, C))
          ? t.self != e && Q(t, C)
            ? (t.scrollLeft = n)
            : t.scrollTo(0, n)
          : (t.style.top = n + "px");
      ...
      function Vn(e, t) {
        (this.anchor = e.getAttribute("data-anchor")),
          (this.item = e),
          (this.index = ie(e, t)),
          (this.isLast = this.index === K(t).length - 1),
