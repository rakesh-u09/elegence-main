...
//     var section = document.querySelector('.animated-row[data-section="slide05"]');
//     var slideTrack = section.querySelector('.slide-track');

//     var observer = new IntersectionObserver(function(entries) {
//         entries.forEach(function(entry) {
//             if (entry.isIntersecting) {
//                 slideTrack.classList.add('animate-slide');
//             } else {
